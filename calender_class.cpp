...
public:
    ...
    void display(calender);
    void increment(calender);
    long int difference_of_days(calender, calender);
    calender insert(calender&);
};
calender calender:: insert(calender &cl)
    {
        int choice;
...
int calender::check_leap(int year)
{
...
int calender::no_of_days_in_month(int month, int year)
{
...
void calender::display(calender cl)
{
    int choice;
...
void calender::increment(calender cl)
{
    calender nd;
    int yr = cl.year;
...
long int calender::difference_of_days(calender cl, calender cl2)
{
...
int main()
{
    ...
    while (1)
    {
        ...
        case 2:
            ...
            cl2.insert(cl2);
            n = cl.difference_of_days(cl, cl2);
